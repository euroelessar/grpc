...
extern "C" GRPCAPI grpc_alts_credentials_options* grpc_alts_credentials_client_options_create();

/* This method creates a grpc ALTS credentials server options instance. */
extern "C" GRPCAPI grpc_alts_credentials_options* grpc_alts_credentials_server_options_create();
