...
#ifndef GRPC_CORE_TSI_ALTS_HANDSHAKER_HANDSHAKER_PB_H
#define GRPC_CORE_TSI_ALTS_HANDSHAKER_HANDSHAKER_PB_H
...
#endif /* GRPC_CORE_TSI_ALTS_HANDSHAKER_HANDSHAKER_PB_H */
